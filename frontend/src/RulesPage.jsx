        ...
        return (
            <div style={{
                ...
                <div className="rules">
                    ...
                    <h1>⸻</h1>
                    <Rule title="7. Score Updates & Communication">
                        {`
                    ...
                    <h1>⸻</h1>
                    <Rule title="8. Determination of Winner">
                        {`
                    ...
                    <h1>⸻</h1>
                    <Rule title="9. Prize Distribution">
                        {`
                    ...
                    <h1>⸻</h1>
                    <Rule title="11. Disputes & Resolution">
                        {`
                ...
                <div className="rules">
                    ...
                    <h1>⸻</h1>
                    <Rule title="5. Fuente Oficial de Resultados">
                        {`
                    ...
                    <h1>⸻</h1>
                    <Rule title="6. Sistema de Puntuación">
                        {`
                            Para cada partido:
                    ...
                    <h1>⸻</h1>
                    <Rule title="7. Actualización de Resultados y Comunicación">
                        {`
                    ...
                    <h1>⸻</h1>
                    <Rule title="8. Determinación del Ganador">
                        {`
                    ...
                    <h1>⸻</h1>
                    <Rule title="9. Entrega de Premios">
                        {`
                    ...
                    <h1>⸻</h1>
                    <Rule title="11. Disputas y Resolución">
                        {`
